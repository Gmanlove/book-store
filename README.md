...
**Bookstore** This project will lay the foundations for Bookstore website. 
Created the user interface using React to:

- Display a list of books.
- Add a book.
- Remove a selected book.

This project is Built using React and Redux front end framework
...
2.navigate to the directory you want remote directory to be cloned to

3.go to the github and copy the url of the repository

4.clone the repository by typing git clone the url copied in step 4

5.navigate to the copy of your cloned repository using cd command
